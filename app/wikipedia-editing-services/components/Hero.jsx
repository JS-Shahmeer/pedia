          ...
          <div className="w-full md:w-7/12 lg:w-6/12 mb-10 md:mb-0">
            <div className="relative">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 capitalize">
                Hire Expert Wikipedia Editors For Your Page
              </h1>

              <p className="text-gray-500 mb-8 text-lg">
                Our certified Wikipedia editors refine and structure your
                content to meet notability standards and comply with guidelines.
                We work within Wikipedia's sandbox and Articles for Creation to
