          ...
          <div className="w-full md:w-7/12 lg:w-6/12 mb-10 md:mb-0">
            <div className="relative">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 capitalize">
                Hire Expert Wikipedia Publishers For Your Page
              </h1>

              <p className="text-gray-500 mb-8 text-lg">
                Our certified Wikipedia publishers manage submission and
                publication, ensuring your page goes live without hassle while
                adhering to all community protocols.
              </p>
