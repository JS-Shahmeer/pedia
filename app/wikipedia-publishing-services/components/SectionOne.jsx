        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
          ...
          <div className="md:w-1/2 w-full">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Expert Wikipedia Publishers Who Navigate the Rules with Precision
            </h2>
            <p className="text-gray-700 mb-4">
              Our team of expert Wikipedia publishers have a deep understanding of
              the platform’s publication policies and community norms. We manage
              the submission through Articles for Creation and communicate with
              Wikipedia editors to get your page published smoothly.
            </p>
            <p className="text-gray-700 mb-6">
              With successful experience across thousands of pages, we ensure
              each publication meets community standards while representing your
              achievements accurately. Trust us to take the technical and
